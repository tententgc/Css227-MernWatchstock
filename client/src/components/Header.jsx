    ...
    <li className="relative group">
      {item.type === "link" ? (
        <>
          ...
          <span className="cursor-pointer text-orange-600 absolute transition-all duration-500 font-bold right-0 top-0 group-hover:right-[90%] opacity-0 group-hover:opacity-100  ">
            /
          </span>
        </>
      ) : (
            ...
            <div className="text-white items-center gap-y-5 lg:text-dark-soft flex flex-col lg:flex-row gap-x-2 font-semibold">
              <div className="relative group">
                <div className="flex flex-col items-center">
                  ...
                  >
                    <ul className="bg-dark-soft lg:bg-zinc-100 text-center flex flex-col shadow-lg rounded-lg overflow-hidden">
                      <button
